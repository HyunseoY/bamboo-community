...
function LoginLayout(props) {
  ...
  return (
    <div className={classes.loginLayout}>
      <div className={classes.rightAngleAction}></div>
      {props.children}
    </div>
  );
}
...
function RegistrationPage(props) {
  ...
  return (
    <div className={classes.loginCard}>
      ...
      <Button fullWidth onClick={backToLogin} color="green">
        Back to log in
      </Button>
    </div>
  );
...
function LoginPage(props) {
  ...
  return (
    <div className={classes.loginCard}>
      ...
      <Divider />
      <Button fullWidth onClick={redirectToRegistration} color="green">
        Create account
      </Button>
    </div>
  );
